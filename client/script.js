...
function sound(){
  var sound = new Audio('/code-fantasy/client/sounds/create.mp3')
  sound.play()//plays the sound
}

function nextsound(){
  var snd = new Audio('/code-fantasy/client/sounds/next.mp3')
  snd.play()//plays the sound
  location.href = "indexteam.html";
  setTimeout
};
